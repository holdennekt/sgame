    ...
    <div className="px-4 py-3 border border-border rounded-lg">
      <div className="flex items-center justify-between gap-2 mb-2">
        <div>
          ...
          <p className="text-xs text-on-surface-muted">{entry.packPreview.name}</p>
        </div>
        <span className="text-xs text-on-surface-muted shrink-0">{formatDate(entry.finishedAt)}</span>
      </div>
